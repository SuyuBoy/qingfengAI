...
function logTag() {
    log('%c❤️ Welcome to klinecharts. Version is 9.8.0', 'border-radius:4px;border:dashed 1px #1677FF;line-height:70px;padding:0 20px;margin:16px 0;font-size:14px;color:#1677FF;', '', '', '', '');
}
...
var ChartStore = /** @class */ (function () {
    ...
    ChartStore.prototype.addData = function (data, isFirstAdd, more) {
        return __awaiter(this, void 0, void 0, function () {
            var success, dataCount, timestamp, lastDataTimestamp, lastBarRightSideDiffBarCount;
        ...
        if (!this._loading &&
            ...
            var cb = function (data, more) {
                ...
                if (params.type === LoadDataType.Backward) {
                    dataList = _this._dataList.concat(data);
                    _this._backwardMore = more !== null && more !== void 0 ? more : false;
                }
                else {
                    dataList = data.concat(_this._dataList);
                    _this._forwardMore = more !== null && more !== void 0 ? more : false;
                }
                _this.addData(dataList, false).then(function () { }).catch(function () { });
            };
            this._loading = true;
...
var Canvas = /** @class */ (function () {
    function Canvas(style, listener) {
        ...
        this._mediaQueryListener = function () {
            ...
            _this._resetPixelRatio(Math.round(_this._element.clientWidth * pixelRatio), Math.round(_this._element.clientHeight * pixelRatio), pixelRatio, pixelRatio);
        };
            ...
            if (result) {
                _this._resizeObserver = new ResizeObserver(function (entries) {
                    ...
                    if (isValid(size)) {
                        ...
                        if (_this._pixelWidth !== width || _this._pixelHeight !== height) {
                            _this._resetPixelRatio(width, height, width / _this._element.clientWidth, height / _this._element.clientHeight);
                        }
                    }
                });
    ...
    Canvas.prototype._resetPixelRatio = function (pixelWidth, pixelHeight, horizontalPixelRatio, verticalPixelRatio) {
        var _this = this;
        this._executeListener(function () {
            ...
            _this._pixelWidth = pixelWidth;
            _this._pixelHeight = pixelHeight;
            _this._element.width = pixelWidth;
            _this._element.height = pixelHeight;
    ...
    Canvas.prototype.update = function (w, h) {
        if (this._width !== w || this._height !== h) {
            ...
            if (!this._supportedDevicePixelContentBox) {
                ...
                this._resetPixelRatio(Math.round(w * pixelRatio), Math.round(h * pixelRatio), pixelRatio, pixelRatio);
            }
        }
        else {
...
var IndicatorTooltipView = /** @class */ (function (_super) {
    ...
    IndicatorTooltipView.prototype.drawImp = function (ctx) {
        ...
        if (isValid(crosshair.kLineData)) {
            ...
            var defaultStyles = chartStore.getStyles().indicator;
            this.drawIndicatorTooltip(ctx, pane.getId(), chartStore.getDataList(), crosshair, activeIcon, indicators, customApi, thousandsSeparator, decimalFoldThreshold, bounding, defaultStyles);
        }
    };
    IndicatorTooltipView.prototype.drawIndicatorTooltip = function (ctx, paneId, dataList, crosshair, activeTooltipIconInfo, indicators, customApi, thousandsSeparator, decimalFoldThreshold, bounding, styles, top) {
        var _this = this;
        ...
        if (this.isDrawTooltip(crosshair, tooltipStyles)) {
            ...
            indicators.forEach(function (indicator) {
                var _a = _this.getIndicatorTooltipData(dataList, crosshair, indicator, customApi, thousandsSeparator, decimalFoldThreshold, styles), name = _a.name, calcParamsText = _a.calcParamsText, values = _a.values, icons = _a.icons;
    ...
    IndicatorTooltipView.prototype.drawStandardTooltipIcons = function (ctx, bounding, currentIcon, activeIcon, icons, startX, startY, prevRowHeight) {
        ...
        if (icons.length > 0) {
            ...
            icons.forEach(function (icon) {
                ...
                (_a = _this.createFigure({
                    name: 'text',
                    attrs: { text: text, x: x, y: y + marginTop },
                    styles: {
        ...
        if (labels.length > 0) {
            ...
            labels.forEach(function (data) {
                ...
                if (title.text.length > 0) {
                    (_a = _this.createFigure({
                        name: 'text',
                        attrs: { x: x, y: y + marginTop_1, text: title.text },
                ...
                (_b = _this.createFigure({
                    name: 'text',
                    attrs: { x: x, y: y + marginTop_1, text: value.text },
        ...
        if (indicator.visible) {
            ...
            eachFigures(dataList, indicator, dataIndex, styles, function (figure, figureStyles) {
                if (isString(figure.title)) {
                    ...
                    values.push({ title: { text: figure.title, color: color }, value: { text: formatFoldDecimal(formatThousands((value !== null && value !== void 0 ? value : tooltipStyles.defaultValue), thousandsSeparator), decimalFoldThreshold), color: color } });
                }
            });
...
var CandleAreaView = /** @class */ (function (_super) {
    ...
    CandleAreaView.prototype.drawImp = function (ctx) {
        ...
        this.eachChildren(function (data, barSpace, i) {
            ...
            var value = kLineData === null || kLineData === void 0 ? void 0 : kLineData[candleAreaStyles.value];
            if (isNumber(value)) {
...
var CandleTooltipView = /** @class */ (function (_super) {
    ...
    CandleTooltipView.prototype.drawImp = function (ctx) {
        ...
        if (isValid(crosshair.kLineData)) {
            ...
            if (candleStyles.tooltip.showType === exports.TooltipShowType.Rect &&
                ...
                this._drawRectTooltip(ctx, dataList, indicators, bounding, yAxisBounding, crosshair, precision, dateTimeFormat, locale, customApi, thousandsSeparator, decimalFoldThreshold, isDrawCandleTooltip, isDrawIndicatorTooltip, styles, 0);
            }
                ...
                var top_1 = this._drawCandleStandardTooltip(ctx, dataList, paneId, bounding, crosshair, activeIcon, precision, dateTimeFormat, locale, customApi, thousandsSeparator, decimalFoldThreshold, candleStyles);
                this.drawIndicatorTooltip(ctx, paneId, dataList, crosshair, activeIcon, indicators, customApi, thousandsSeparator, decimalFoldThreshold, bounding, indicatorStyles, top_1);
            }
            else if (candleStyles.tooltip.showType === exports.TooltipShowType.Rect &&
                indicatorStyles.tooltip.showType === exports.TooltipShowType.Standard) {
                var top_2 = this.drawIndicatorTooltip(ctx, paneId, dataList, crosshair, activeIcon, indicators, customApi, thousandsSeparator, decimalFoldThreshold, bounding, indicatorStyles, 0);
                var isDrawCandleTooltip = this.isDrawTooltip(crosshair, candleStyles.tooltip);
                this._drawRectTooltip(ctx, dataList, indicators, bounding, yAxisBounding, crosshair, precision, dateTimeFormat, locale, customApi, thousandsSeparator, decimalFoldThreshold, isDrawCandleTooltip, false, styles, top_2);
            }
            else {
                var top_3 = this._drawCandleStandardTooltip(ctx, dataList, paneId, bounding, crosshair, activeIcon, precision, dateTimeFormat, locale, customApi, thousandsSeparator, decimalFoldThreshold, candleStyles);
                var isDrawIndicatorTooltip = this.isDrawTooltip(crosshair, indicatorStyles.tooltip);
                this._drawRectTooltip(ctx, dataList, indicators, bounding, yAxisBounding, crosshair, precision, dateTimeFormat, locale, customApi, thousandsSeparator, decimalFoldThreshold, false, isDrawIndicatorTooltip, styles, top_3);
            }
        }
    };
    CandleTooltipView.prototype._drawCandleStandardTooltip = function (ctx, dataList, paneId, bounding, crosshair, activeTooltipIcon, precision, dateTimeFormat, locale, customApi, thousandsSeparator, decimalFoldThreshold, styles) {
        var _a, _b, _c;
        var tooltipStyles = styles.tooltip;
        ...
        if (this.isDrawTooltip(crosshair, tooltipStyles)) {
            ...
            var values = this._getCandleTooltipData({ prev: (_b = dataList[dataIndex - 1]) !== null && _b !== void 0 ? _b : null, current: crosshair.kLineData, next: (_c = dataList[dataIndex + 1]) !== null && _c !== void 0 ? _c : null }, precision, dateTimeFormat, locale, customApi, thousandsSeparator, decimalFoldThreshold, styles);
            var x = 0;
            var y = 0;
            var prevRowHeight = 0;
    ...
    CandleTooltipView.prototype._drawRectTooltip = function (ctx, dataList, indicators, bounding, yAxisBounding, crosshair, precision, dateTimeFormat, locale, customApi, thousandsSeparator, decimalFoldThreshold, isDrawCandleTooltip, isDrawIndicatorTooltip, styles, top) {
        var _this = this;
        var _a, _b, _c, _d, _e;
        var candleStyles = styles.candle;
        var indicatorStyles = styles.indicator;
        ...
        if (isDrawCandleTooltip || isDrawIndicatorTooltip) {
            var dataIndex = (_a = crosshair.dataIndex) !== null && _a !== void 0 ? _a : 0;
            var candleTooltipDatas = this._getCandleTooltipData({ prev: (_b = dataList[dataIndex - 1]) !== null && _b !== void 0 ? _b : null, current: crosshair.kLineData, next: (_c = dataList[dataIndex + 1]) !== null && _c !== void 0 ? _c : null }, precision, dateTimeFormat, locale, customApi, thousandsSeparator, decimalFoldThreshold, candleStyles);
    ...
    CandleTooltipView.prototype._getCandleTooltipData = function (data, precision, dateTimeFormat, locale, customApi, thousandsSeparator, decimalFoldThreshold, styles) {
...
var ChartImp = /** @class */ (function () {
    ...
    ChartImp.prototype.applyNewData = function (data, more, callback) {
        ...
        this._chartStore.addData(data, true, more).then(function () { }).catch(function () { }).finally(function () { callback === null || callback === void 0 ? void 0 : callback(); });
    };
    /**
     * @deprecated
     * Since v9.8.0 deprecated, since v10 removed
    ...
    ChartImp.prototype.applyMoreData = function (data, more, callback) {
        ...
        var dataList = data.concat(this._chartStore.getDataList());
        this._chartStore.addData(dataList, false, more !== null && more !== void 0 ? more : true).then(function () { }).catch(function () { }).finally(function () { callback === null || callback === void 0 ? void 0 : callback(); });
    };
    ChartImp.prototype.updateData = function (data, callback) {
        ...
        this._chartStore.addData(data, false).then(function () { }).catch(function () { }).finally(function () { callback === null || callback === void 0 ? void 0 : callback(); });
    };
    /**
     * @deprecated
     * Since v9.8.0 deprecated, since v10 removed
